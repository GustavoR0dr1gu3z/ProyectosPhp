...
//$conexion->close();
		...
		<form name="bajaAlumno" method="POST" action="EliminaAlumno.php">
 			ID del Beneficiario a eliminar: <input type="text" name="id" style="margin-top: 1.5rem" required="required" placeholder="Eliminar Beneficiario" size="30"><br /> <br>
 			<button type="submit">Enviar</button><br>
 		</form>
<br>
 		<h3 align="center">LISTADO DE BENEFICIARIOS</h3><br>
