            ...
            <div class="container">
                ...
                <div class="col-md-7">
                    <form class="form-horizontal" action="" method="post">
                        ...
                        <div class="form-group">					
                            <input type="text" name="cedula_profecional" class="form-control" placeholder="cedula_profecional" required>
                        </div>
                        <div class="form-group">					
                    ...
                    <!--
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="submit" name="add_medico" class="btn btn-sm btn-primary" value="Guardar datos">
